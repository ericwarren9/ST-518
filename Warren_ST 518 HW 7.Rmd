...
This output matches what we found in SAS so we should be very confident we found the stanard errors. Also not the adjusted means also match from what we got before. As we can see the standard error for treatment 1 is 0.3201005 and the standard error for treatment 4 is 0.2839864 (which also seems to match the intercept standard error from the output). We can now fill out our table completely. 
